...
async function loadMovie(){
  const res = await fetch(`https://api.themoviedb.org/3/movie/${movieId}?api_key=${API_KEY}&append_to_response=credits,similar`);
  ...
  data.similar.results.slice(0,6).forEach(movie=>{
